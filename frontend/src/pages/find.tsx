  ...
  return (
    <>
      ...
      <div className={styles["find-users"]}>
        <img className={styles["find-user-img"]} 
        ...
        <div className={styles["find-user-text-content"]}>
          ...
          <h2 className={styles["find-user-likes"]}>likes <b>coffee</b></h2>
          <h2 className={styles["find-user-shops"]}>frequents <b>starbucks, peets</b></h2>
        </div>
